...
st.markdown("<h1 style='text-align: center;'>Ava - an Azure OpenAI ChatGPT chatbot 😬</h1>", unsafe_allow_html=True)

st.markdown("Welcome to Azure OpenAI ChatGPT app. Please log in to continue.")
